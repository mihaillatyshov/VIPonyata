...
import { setDrillingDoneTask, setDrillingInfo, setDrillingItems } from "redux/slices/drillingSlice";
...
const StudentDrillingPage = () => {
    ...
    const goToNextTaskHandle = (taskTypeName, percent) => {
                    ...
                    <div>
                        ...
                        <Routes>
                            ...
                            <Route
                                ...
                                element={
                                    <StudentDrillingCard
                                        cards={drilling.items.drillingcard}
